...
<body > 
    ...
    <form class="container-table container-table--edit" action="EliminarDatosBoton.php" method="post">
    ...
    while($row= mysqli_fetch_assoc($resultado)){ ?>
     ...
     <input type="text" class="table__item" value=" <?php echo $row["pass"]; ?>" name="pass">
        <?php } ?>
        <input type="submit" value="eliminar" class="container__submit container__submit--actualizar">
    </form>
    <div id="formFooter">
